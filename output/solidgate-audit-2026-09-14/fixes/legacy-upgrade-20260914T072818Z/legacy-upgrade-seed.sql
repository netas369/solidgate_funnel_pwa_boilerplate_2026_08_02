...
SELECT ('82000000-0000-4000-8000-'||LPAD((200+i)::TEXT,12,'0'))::UUID,
  ...
  'BRAND_000000_SUB','BRAND_000000_SUB',status,net,'usd',1000,payment,
...
FROM (VALUES
  (1,'completed',1000,0,0,'settle_ok'),
  (2,'refunded',0,1000,0,'refunded'),
  (3,'completed',600,400,0,'refunded'),
  (4,'disputed',0,0,1000,'settle_ok')
